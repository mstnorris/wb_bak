...
<ol class="breadcrumb">
    <li><a href="/universities/{{ $school->university->wbid }}"><i class="fa fa-university"></i>&nbsp;{{ $school->university->name }}</a></li>
    <li class="active"><a href="/schools/{{ $school->wbid }}"><i class="fa fa-building"></i>&nbsp;{{ $school->name }}</a></li>
</ol>
...
<ul class="nav nav-tabs nav-justified">
    <li class="active"><a href="#dashboard" data-toggle="tab">Information</a></li>
    <li><a href="#studyMaterials" data-toggle="tab">Contact</a></li>
    <li><a href="#assignments" data-toggle="tab">Awards</a></li>
    <li><a href="#contacts" data-toggle="tab">Faculties</a></li>
</ul>
<div class="container-fluid">
            ...
            <a href="#">
                <div class="panel panel-warning">
                    <div class="panel-heading text-center">
                        <p class="announcement-heading">{{ $school->courses->count() }}</p>
...
<div class="tab-pane" id="studyMaterials">
    ...
    <div class="row bottom-border">
        ...
        <div class="col-sm-6 col-xs-12">
            <div class="well">
                <p><i class="fa fa-building fa-5x"></i></p>

                <p>Download {{ $school->type }} file</p>
            </div>
        </div>
